...
namespace CelcatManagement\LDAPManagerBundle\LDAP\Core;

use CelcatManagement\LDAPManagerBundle\LDAP\API\DriverInterface;
...
use CelcatManagement\LDAPManagerBundle\LDAP\Exception\DeleteException;
...
class Manager
{
     ...
     * @return void
     *
     * @throws CelcatManagement\LDAPManagerBundle\LDAP\Exception\ConnectionException if connection fails
     * @throws CelcatManagement\LDAPManagerBundle\LDAP\Exception\OptionException if connection configuration fails
     */
     ...
     * @return void
     *
     * @throws CelcatManagement\LDAPManagerBundle\LDAP\Exception\BindException if binding fails
     */
