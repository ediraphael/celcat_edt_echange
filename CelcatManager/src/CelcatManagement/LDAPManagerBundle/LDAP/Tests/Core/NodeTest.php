...
namespace CelcatManagement\LDAPManagerBundle\LDAP\Tests\Core;
...
use CelcatManagement\LDAPManagerBundle\LDAP\Exception\RebaseException;
...
class NodeTest extends TestCase
{
    ...
    public function testHydrateFromEntry()
    {
        ...
        $this->assertInstanceOf('CelcatManagement\LDAPManagerBundle\LDAP\Core\NodeAttribute', $attr);
    ...
    public function testGet()
    {
        ...
        $test = $node->get('a');
        $this->assertInstanceOf('CelcatManagement\LDAPManagerBundle\LDAP\Core\NodeAttribute', $test);
        ...
        $this->assertInstanceOf(
            'CelcatManagement\LDAPManagerBundle\LDAP\Core\NodeAttribute',
            $test,
