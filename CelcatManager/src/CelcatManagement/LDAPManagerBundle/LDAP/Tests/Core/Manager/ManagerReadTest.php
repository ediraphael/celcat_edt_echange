...
namespace CelcatManagement\LDAPManagerBundle\LDAP\Tests\Core\Manager;

use CelcatManagement\LDAPManagerBundle\LDAP\Core\Manager;
use CelcatManagement\LDAPManagerBundle\LDAP\Core\Node;
use CelcatManagement\LDAPManagerBundle\LDAP\API\SearchInterface;
use CelcatManagement\LDAPManagerBundle\LDAP\Platform\Test\Connection;
use CelcatManagement\LDAPManagerBundle\LDAP\Platform\Test\Entry;
use CelcatManagement\LDAPManagerBundle\LDAP\Platform\Test\Search;
use CelcatManagement\LDAPManagerBundle\LDAP\Exception\NotBoundException;
use CelcatManagement\LDAPManagerBundle\LDAP\Exception\SizeLimitException;
use CelcatManagement\LDAPManagerBundle\LDAP\Exception\MalformedFilterException;
use CelcatManagement\LDAPManagerBundle\LDAP\Exception\SearchException;
use CelcatManagement\LDAPManagerBundle\LDAP\Exception\NodeNotFoundException;
...
class ManagerReadTest extends ManagerTest
{
    ...
    public function testGetNode()
    {
        ...
        try {
            ...
            $this->assertEquals('CelcatManagement\LDAPManagerBundle\LDAP\Exception\SearchException', get_class($e));
        ...
        $this->assertInstanceOf('CelcatManagement\LDAPManagerBundle\LDAP\Core\Node', $node);
    ...
    public function testSearch()
    {
        ...
        $this->assertInstanceOf('CelcatManagement\LDAPManagerBundle\LDAP\Core\SearchResult', $result);

        $data = array();
        foreach ($result as $key => $value) {
            $this->assertInstanceOf('CelcatManagement\LDAPManagerBundle\LDAP\Core\Node', $value);
        ...
        $this->assertInstanceOf(
            'CelcatManagement\LDAPManagerBundle\LDAP\Core\SearchResult',
            $result,
