...
use CelcatManagement\LDAPManagerBundle\LDAP\Exception\OptionException;
use CelcatManagement\LDAPManagerBundle\LDAP\Exception\BindException;
use CelcatManagement\LDAPManagerBundle\LDAP\Exception\PersistenceException;
use CelcatManagement\LDAPManagerBundle\LDAP\Exception\NoResultException;
...
class ConnectionTest extends TestCase
{
    ...
    public function testSearch()
    {
        ...
        $this->assertInstanceOf('CelcatManagement\LDAPManagerBundle\LDAP\API\SearchInterface', $search);
    ...
    public function testSearchesExceptionHandling()
    {
        ...
        try {
            ...
            $this->assertEquals(
                'CelcatManagement\LDAPManagerBundle\LDAP\Exception\SearchException',
                get_class($e),
    ...
    protected function assertSearchLog(
        ...
        $this->assertInstanceOf('CelcatManagement\LDAPManagerBundle\LDAP\Platform\Test\Search', $log['data']);
